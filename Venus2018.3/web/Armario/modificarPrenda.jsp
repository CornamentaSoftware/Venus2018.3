		...
		if(ServletFileUpload.isMultipartContent(src)){
			...
			while(it.hasNext()){
				...
				if(item.isFormField()){                          
                                        ...
                                        if (item.getFieldName().equals("idPrendaSelect")){
                                            idPrenda=Integer.parseInt(item.getString());
                                        }
                                        if (item.getFieldName().equals("link"))
                                            objeto=item.getString();
                                }
				else
				{
                                    try{
            ...
            try {
                sta.executeUpdate("call updatePrenda("+idPrenda+","+TipoPrendaInt+","+TallaInt+",'"+objeto+"','"+Descripcion+"','"+Precio+"','"+Favorito+"','"+Intercambiable+"');");
                con.close();
                out.println("<script>alert('Cambios guardados exitosamente');'</script>");
